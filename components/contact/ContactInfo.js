    ...
    <div className="space-y-12">
      <AnimatedSection>
        ...
        <p className="text-gray-600 text-lg leading-relaxed mb-10">
          Whether you need assistance with US or UK taxation, accounting, or
          business strategy, our team of certified experts is ready to help you
      ...
      <AnimatedSection delay={0.2}>
        <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100">
          ...
          <p className="text-gray-700 mb-4">
            We proudly serve clients across the globe, with specialized teams
            dedicated to US and UK jurisdictions.
          </p>
          <div className="flex gap-4">
            <span className="px-3 py-1 bg-white text-primary rounded-full text-sm font-semibold shadow-sm">
              USA
            </span>
            <span className="px-3 py-1 bg-white text-primary rounded-full text-sm font-semibold shadow-sm">
              United Kingdom
