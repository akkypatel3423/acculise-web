...
export const blogPosts = [
  {
    ...
    excerpt: 'A comprehensive guide to the latest IRS updates and how they impact corporate tax strategies for the upcoming fiscal year.',
    category: 'US Tax',
    date: 'Oct 15, 2025',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'HMRC is expanding MTD requirements. Learn who is affected and the steps you need to take to ensure compliance.',
    category: 'UK Tax',
    date: 'Oct 10, 2025',
    readTime: '5 min read',
    author: 'James Wilson, ACA',
    image: 'https://images.unsplash.com/photo-1454165833767-027ffea70c46?auto=format&fit=crop&q=80&w=1200',
    slug: 'mtd-uk-transition',
    content: 'Long form content about MTD in the UK...'
  },
  {
    title: 'The Future of AI in Cloud Accounting',
    excerpt: 'How artificial intelligence is transforming bookkeeping processes and providing real-time financial insights.',
    category: 'Technology',
    date: 'Sep 28, 2025',
    readTime: '8 min read',
    author: 'Alex Rivera',
    image: 'https://images.unsplash.com/photo-1485827362309-4df3527055c8?auto=format&fit=crop&q=80&w=1200',
    slug: 'ai-cloud-accounting',
    content: 'Long form content about AI in accounting...'
  },
  {
    title: 'Optimizing Cash Flow for Scale',
    excerpt: 'Practical strategies to manage accounts receivable and payable effectively to maintain healthy liquidity.',
    category: 'Accounting',
    date: 'Sep 15, 2025',
    readTime: '4 min read',
    author: 'Michael Chen',
  ...
  },
  {
    ...
    excerpt: 'Understand how distance selling rules and VAT OSS/IOSS impact your e-commerce expansion into Europe.',
    category: 'UK Tax',
    date: 'Sep 05, 2025',
    readTime: '7 min read',
    author: 'James Wilson, ACA',
  ...
  },
  {
    ...
    excerpt: 'The mandatory capitalization of R&D expenses has changed the game for tech startups. Here is what you need to know.',
    category: 'US Tax',
    date: 'Aug 22, 2025',
  ...
  },
  {
    ...
    excerpt: 'Moving beyond basic bookkeeping to strategic financial leadership. Signs your business is ready for a fractional CFO.',
    category: 'Accounting',
    date: 'Aug 10, 2025',
    readTime: '5 min read',
    author: 'Michael Chen',
              ...
              <article className="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100 flex flex-col h-full">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-700 uppercase tracking-widest">{post.author}</span>
                    <Link 
                      href={`/blog/${post.slug}`} 
