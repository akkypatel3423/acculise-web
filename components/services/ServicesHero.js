  ...
  return (
    <section className="relative pt-48 pb-32 bg-primary overflow-hidden text-center lg:text-left">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-indigo-500 rounded-full blur-[150px] translate-y-1/2 -translate-x-1/2"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
        <AnimatedSection className="max-w-4xl">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-12 italic">
            Engineered <br/>
            <span className="text-secondary underline decoration-white/10 decoration-8 underline-offset-4">Portfolio.</span>
          </h1>
          ...
          <p className="text-xl text-blue-100/60 leading-relaxed max-w-2xl font-medium border-l-2 border-white/10 pl-8">
            ...
            Providing the technical backbone for global scale and compliance.
          </p>
        </AnimatedSection>
      </div>
    </section>
