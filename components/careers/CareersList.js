...
export const jobsList = [
  {
    ...
    description:
      "Lead our US tax compliance team for mid-market clients. Requires deep expertise in Forms 1040, 1120, and 1065.",
  ...
  },
  {
    ...
    description:
      "Manage a portfolio of UK SMEs, ensuring HMRC compliance and tax efficiency. ACCA/ACA required.",
    email: "info@acculise.com",
  },
  {
    ...
    description:
      "High-volume reconciliation and month-end closing support for international e-commerce scale-ups.",
    email: "info@acculise.com",
  },
];
...
export default function CareersList() {
  const handleApply = (jobTitle) => {
    ...
    const body = encodeURIComponent(
      `Hi Acculise Solutions Team,\n\nI am interested in the ${jobTitle} position and have attached my CV for your review.`,
    );
    window.location.href = `mailto:info@acculise.com?subject=${subject}&body=${body}`;
  };
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-6 mb-8">
                      <div className="flex items-center text-slate-500">
                        <svg
                          className="w-5 h-5 mr-3 text-primary opacity-50"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
        ...
        <AnimatedSection delay={0.4} className="mt-20">
          <div className="bg-gradient-to-r from-primary to-blue-800 rounded-[3rem] p-12 text-center text-white relative overflow-hidden">
            ...
            <p className="text-blue-100/70 mb-8 max-w-xl mx-auto">
              We&apos;re always looking for exceptional talent in accounting,
              tax, and fintech. Send your open application to our hiring team.
            </p>
            <button
              onClick={() =>
                (window.location.href =
                  "mailto:info@acculise.com?subject=Open Application")
              }
